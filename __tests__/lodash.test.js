...
describe('lodash all function', () => {
  test("chunk(['a', 'b', 'c', 'd'], 2)", () => {
    expect(chunk(['a', 'b', 'c', 'd'], 2)).toStrictEqual(_.chunk(['a', 'b', 'c', 'd'], 2));
  });
  test("chunk(['a', 'b', 'c', 'd'], 3)", () => {
    expect(chunk(['a', 'b', 'c', 'd'], 3)).toStrictEqual(_.chunk(['a', 'b', 'c', 'd'], 3));
  });

  test("compact([0, 1, false, 2, '', 3])", () => {
    expect(compact([0, 1, false, 2, '', 3])).toStrictEqual(_.compact([0, 1, false, 2, '', 3]));
  });

  test("concat([1], 2, [3], [[4]])", () => {
    expect(concat([1], 2, [3], [[4]])).toStrictEqual(_.concat([1], 2, [3], [[4]]));
  });

  test("difference([3, 2, 1], [4, 2])", () => {
    expect(difference([3, 2, 1], [4, 2])).toStrictEqual(_.difference([3, 2, 1], [4, 2]));
  });

  test("differenceBy([3.1, 2.2, 1.3], [4.4, 2.5], Math.floor)", () => {
    expect(differenceBy([3.1, 2.2, 1.3], [4.4, 2.5], Math.floor)).toStrictEqual(_.differenceBy([3.1, 2.2, 1.3], [4.4, 2.5], Math.floor));
  });
  test("differenceBy([{ 'x': 2 }, { 'x': 1 }], [{ 'x': 1 }], 'x')", () => {
    expect(differenceBy([{ 'x': 2 }, { 'x': 1 }], [{ 'x': 1 }], 'x')).toStrictEqual(_.differenceBy([{ 'x': 2 }, { 'x': 1 }], [{ 'x': 1 }], 'x'));
  });
  ...
  test("dropRightWhile(users, (o) => !o.active)", () => {
    ...
    expect(dropRightWhile(users, (o) => !o.active)).toStrictEqual(_.dropRightWhile(users, (o) => !o.active));
  });
  test("dropRightWhile(users, { 'user': 'pebbles', 'active': false })", () => {
    ...
    expect(dropRightWhile(users, { 'user': 'pebbles', 'active': false })).toStrictEqual(_.dropRightWhile(users, { 'user': 'pebbles', 'active': false }));
  });
  test("dropRightWhile(users, ['active', false])", () => {
    ...
    expect(dropRightWhile(users, ['active', false])).toStrictEqual(_.dropRightWhile(users, ['active', false]));
  });
  test("dropRightWhile(users, 'active')", () => {
    ...
    expect(dropRightWhile(users, 'active')).toStrictEqual(_.dropRightWhile(users, 'active'));
  });
  ...
  test("fill([4, 6, 8, 10], '*', 1, 3)", () => {
    expect(fill([4, 6, 8, 10], '*', 1, 3)).toStrictEqual(_.fill([4, 6, 8, 10], '*', 1, 3));
  });
  ...
  test("findIndex(users, function(o) { return o.user == 'barney'; })", () => {
    ...
    expect(findIndex(users, (o) => o.user === 'barney')).toStrictEqual(_.findIndex(users, (o) => o.user === 'barney'));
  });
  test("findIndex(users, { 'user': 'fred', 'active': false })", () => {
    ...
    expect(findIndex(users, { 'user': 'fred', 'active': false })).toStrictEqual(_.findIndex(users, { 'user': 'fred', 'active': false }));
  });
  test("findIndex(users, ['active', false])", () => {
    ...
    expect(findIndex(users, ['active', false])).toStrictEqual(_.findIndex(users, ['active', false]));
  });
  test("findIndex(users, 'active')", () => {
    ...
    expect(findIndex(users, 'active')).toStrictEqual(_.findIndex(users, 'active'));
  });
  ...
  test("findLastIndex(users, function(o) { return o.user == 'pebbles'; })", () => {
    ...
    expect(findLastIndex(users, (o) => o.user === 'pebbles')).toStrictEqual(_.findLastIndex(users, (o) => o.user === 'pebbles'));
  });
  test("findIndex(users, { 'user': 'fred', 'active': false })", () => {
    const users = [
      { 'user': 'barney', 'active': true },
  ...
  test("findLastIndex(users, { 'user': 'barney', 'active': true })", () => {
    ...
    expect(findLastIndex(users, { 'user': 'barney', 'active': true })).toStrictEqual(_.findLastIndex(users, { 'user': 'barney', 'active': true }));
  });
  test("findLastIndex(users, ['active', false])", () => {
    ...
    expect(findLastIndex(users, ['active', false])).toStrictEqual(_.findLastIndex(users, ['active', false]));
  });
  test("findLastIndex(users, 'active')", () => {
    ...
    expect(findLastIndex(users, 'active')).toStrictEqual(_.findLastIndex(users, 'active'));
  });

  test("flatten([1, [2, [3, [4]], 5]])", () => {
    expect(flatten([1, [2, [3, [4]], 5]])).toStrictEqual(_.flatten([1, [2, [3, [4]], 5]]));
  });
  ...
  test("flattenDeep([1, [2, [3, [4]], 5]])", () => {
    expect(flattenDeep([1, [2, [3, [4]], 5]])).toStrictEqual(_.flattenDeep([1, [2, [3, [4]], 5]]));
  });

  test("fromPairs([['a', 1], ['b', 2]])", () => {
    expect(fromPairs([['a', 1], ['b', 2]])).toStrictEqual(_.fromPairs([['a', 1], ['b', 2]]));
  });
  ...
  test("indexOf([1, 2, 1, 2], 2, 2)", () => {
    expect(indexOf([1, 2, 1, 2], 2, 2)).toStrictEqual(_.indexOf([1, 2, 1, 2], 2, 2));
  });
  ...
  test("intersection([2, 1], [4, 2], [1, 2])", () => {
    expect(intersection([2, 1], [4, 2], [1, 2])).toStrictEqual(_.intersection([2, 1], [4, 2], [1, 2]));
  });

  test("join(['a', 'b', 'c'], '~')", () => {
    expect(join(['a', 'b', 'c'], '~')).toStrictEqual(_.join(['a', 'b', 'c'], '~'));
  });
